  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-card border border-purple-500/20 rounded-2xl p-6 shadow-lg shadow-black/20">
        ...
        {safeMode && (
          <div className="mt-4 p-3 bg-yellow-500/5 border border-yellow-500/20 rounded-lg flex items-center gap-2">
            <span>⚠️</span>
            <span className="text-yellow-400 text-sm font-body">SAFE MODE ACTIV — VIX ridicat, botul nu plasează ordine noi.</span>
          </div>
        )}
      ...
      <div className="grid grid-cols-2 xl:grid-cols-4 gap-4">
        ...
        <div className="bg-card border border-border-subtle rounded-xl p-5 shadow-lg shadow-black/20">
          ...
          {loading ? <div className="h-7 bg-card-hover rounded animate-pulse w-16 mb-1" /> : (
            <>
              <p className="text-2xl font-mono font-semibold">{openPos}<span className="text-muted-foreground text-base">/15</span></p>
        ...
        <div className="bg-card border border-border-subtle rounded-xl p-5 shadow-lg shadow-black/20">
          ...
          {loading ? <div className="h-7 bg-card-hover rounded animate-pulse w-16 mb-1" /> : (
            <>
              ...
              <p className="text-xs text-muted-foreground mt-1">P&L: <span className={totalPl >= 0 ? "text-accent" : "text-danger"}>{totalPl >= 0 ? "+" : ""}{totalPl.toFixed(2)}$</span></p>
            </>
          )}
        </div>
      </div>
      ...
      <div className="bg-card border border-border-subtle rounded-2xl p-6 shadow-lg shadow-black/20">
        ...
        <div className="flex gap-4 mt-3">
          <div className="flex items-center gap-1.5"><span className="w-2 h-2 rounded-full bg-purple-400"></span><span className="text-xs text-muted-foreground font-body">Stocks (15 simboluri)</span></div>
          <div className="flex items-center gap-1.5"><span className="w-2 h-2 rounded-full bg-blue-400"></span><span className="text-xs text-muted-foreground font-body">ETF-uri (9 simboluri)</span></div>
          <div className="flex items-center gap-1.5"><span className="w-2 h-2 rounded-full bg-orange-400"></span><span className="text-xs text-muted-foreground font-body">Crypto 24/7 (3 simboluri)</span></div>
        </div>
      </div>
      ...
      <div className="bg-card border border-border-subtle rounded-2xl p-6 shadow-lg shadow-black/20">
        ...
        {loading ? (
          ...
          <div className="text-center py-8">
            ...
            <p className="text-muted-foreground text-sm font-body">Botul v3 este activ și monitorizează piața.</p>
            <p className="text-muted-foreground text-xs font-body mt-1">Primul trade va apărea când condițiile sunt îndeplinite.</p>
          </div>
        ) : (
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-border-subtle">
                  ...
                  <th className="text-right py-2 px-3 text-xs text-muted-foreground font-body font-normal hidden sm:table-cell">Confidence</th>
                </tr>
              </thead>
              <tbody>
                {trades.map((t) => (
